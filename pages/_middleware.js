...
export default function middleware(req) {
  ...
  const hostname = req.headers.get('host'); // get hostname of request (e.g. demo.myhomecomp.com)

  // only for demo purposes – remove this if you want to use your root domain as the landing page
  // if (hostname === "myhomecomp.com" || hostname === "platforms.vercel.app") {
  //   return NextResponse.redirect("https://demo.myhomecomp.com");
  // }

  const currentHost =
    process.env.NODE_ENV === 'production' && process.env.VERCEL === '1'
      ? hostname.replace(`.myhomecomp.com`, '') // you have to replace ".myhomecomp.com" with your own domain if you deploy this example under your domain.
